CREATE FUNCTION F_PRECEDENTE_CONGUAGLIO(i_atr_progressivo int(11), i_atr_riga int(11)) 
	RETURNS date
    DETERMINISTIC
    COMMENT 'calcola la data del precedente conguaglio del contratto'
BEGIN
...
select date_sub(rata, interval 1 day) precedente_conguaglio
from
