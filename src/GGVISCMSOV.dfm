inherited VISCMSOV: TVISCMSOV
  ...
  object tab_control: TRzPageControl [2]
    ...
    Height = 586
    Hint = ''
    ActivePage = tab_ah6_preventivi_clienti
    Align = alClient
    CutCornerSize = 3
    ShowShadow = False
    TabIndex = 6
    ...
    object tab_ah6_preventivi_clienti: TRzTabSheet
      Color = clWindow
      ...
      ExplicitWidth = 0
      ExplicitHeight = 0
      object v_ah6_griglia_preventivi_clienti: trzdbgrid_go
        Left = 0
        Top = 0
        Width = 990
        Height = 564
        Hint = '[Invio o doppio click = assegna progressivo]'
        Align = alClient
        DataSource = ah6_preventivi_clienti_ds
        DrawingStyle = gdsClassic
        PopupMenu = Popup_griglia
        ReadOnly = True
        TabOrder = 0
        ...
        TitleFont.Name = 'Microsoft Sans Serif'
        TitleFont.Style = []
        OnDblClick = v_ah6_griglia_preventivi_clientiDblClick
        OnKeyDown = v_ah6_griglia_preventivi_clientiKeyDown
        Columns = <
          item
            Expanded = False
            FieldName = 'tipologia'
  ...
  object ah6_preventivi_clienti: TMyQuery_go
    Connection = ARC.arcdit
    SQL.Strings = (
  ...
  object ah6_preventivi_clienti_ds: TMyDataSource
    DataSet = ah6_preventivi_clienti
    Left = 510
    Top = 65531
  end
end
