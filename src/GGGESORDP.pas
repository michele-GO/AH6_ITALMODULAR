...
uses
  DMARC, GGGESORDP1, GGGESORDP2, GGGESMOV, GGDDTCLAV, ZZSELEZIONE, GGFORMULADSB, ZZCREA_DDT_CL, 
  ZZPARSING, GGANAEQU, GGNTVENACQ, GGLTTERLASINH, GGGESORDPCINH, GGDISORDP, GGVISEQU,
  GGDIFFORDP, GGIMPALF, GGEVAFAS, GGEVAORDP, GGMOVORDP, GGSTAORDPETI, GGGESDAV, ZZTOTORDP,
  GGSTOORDP01, GGDATCONFAS, GGDELORDP, GGSTOMOVORDP, ZZVARIANTI_DSB, GGEVARMA,
  ZZLOTTO_NUMERICO, ZZEVAODP, ZZHELPER, ZZUTILS.PRODUZIONE, ZZUTILS.COMMESSE, ZZUTILS.MAGAZZINO;
