...
//modifica
procedure TGESACQ.tabella_righeBeforePost(DataSet: TDataSet);
begin
  inherited;
  if tda.fieldbyname('ah6_commessa_obbligatoria').asstring = 'si' then
  begin
    if tabella_righe.fieldbyname('cms_codice').asstring = '' then
    begin
      messaggio(000, 'manca il codice commessa sulla riga del documento' + slinebreak +
