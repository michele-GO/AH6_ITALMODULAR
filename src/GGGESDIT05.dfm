    ...
    inherited tab_control: TRzPageControl
      ...
      object tab_pagina_ah6_personalizzazioni: TRzTabSheet
        ...
        object ah6_lb_tin_codice: TRzLabel
          ...
          Width = 203
          Height = 13
          Caption = 'categoria inventario controllo esistenza dsb'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Microsoft Sans Serif'
        ...
        object v_ah6_tin_codice: trzdbedit_go
          Left = 10
          Top = 25
          Width = 50
          Height = 21
          Hint = 'codice categoria omogenea per inventario [F4 F5 F6]'
          Margins.Left = 1
          Margins.Top = 1
          DataSource = tabella_ds
          DataField = 'ah6_tin_codice'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Microsoft Sans Serif'
          ...
          ReadOnlyColorOnFocus = True
          TabOrder = 0
          OnExit = v_ah6_tin_codiceExit
          lookcolldatabase = 'arc.arcdit'
          lookcollpopupmenu = ARC.pop_arc
          lookcollprogram = 'GESTIN'
          lookcolltable = 'TIN'
          lookcollvisname = 'TIN'
        end
