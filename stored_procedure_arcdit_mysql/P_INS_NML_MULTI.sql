CREATE PROCEDURE P_INS_NML_MULTI
(
...
IN descrizione VARCHAR(40)
    ...
    MODIFIES SQL DATA
    COMMENT 'inserimento / modifica riferimento multiaziendale'
BEGIN
	...
	ciclo_inserimento: LOOP
		...
		set @query_inserimento = CONCAT("replace into " , nome_db, ".nml (select * from " , schema(),
			".nml where nom_codice = ", quote(nom_codice) ," and ind_codice = ", quote(ind_codice) , " and descrizione = ", quote(descrizione) ,") ;");
