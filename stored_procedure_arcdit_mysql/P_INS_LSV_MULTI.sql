CREATE PROCEDURE P_INS_LSV_MULTI
(
IN art_codice VARCHAR(50),
IN tlv_codice VARCHAR(04),
IN data_inizio DATE
)
    MODIFIES SQL DATA
...
BEGIN
	...
	DECLARE cursore CURSOR FOR
		...
		where arc.prd.prg_codice = 'GESLSV'
	...
	set @query_inserimento = CONCAT("replace into ", nome_db, ".lsv (select * from ", schema(), 
	    ".lsv where art_codice = '", art_codice, "' and tlv_codice = '", tlv_codice, "' and data_inizio = '", data_inizio, "');");
