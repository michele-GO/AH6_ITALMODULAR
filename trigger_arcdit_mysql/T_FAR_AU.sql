...
or old.no_ordinato <> new.no_ordinato then
  ...
  CALL P_MOVACQ_FAR('far', 'si', old.art_codice, old.tma_codice, old.situazione, old.progressivo,
  ...
  CALL P_MOVACQ_FAR('far', 'no', new.art_codice, new.tma_codice, new.situazione, new.progressivo,
